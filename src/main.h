#ifndef MOMDAY_MAIN_H_
#define MOMDAY_MAIN_H_

#include "framework.h"

// Messages to draw to screen
static const std::wstring kMomMessage1 = L"Happy Mothers Day!";
static const std::wstring kMomMessage2 = L"Love da Laura";
